...
var questions = [
  (myQ1 = {
    ...
    answer: "4",
    choices: [
      "a variable available to multiple projects",
      "a variable available to a specific function",
      "a variable available to the internet",
      "a variable available throughout the length of the code",
    ],
  }),
  (myQ2 = {
  ...
  (myQ6 = {
    ...
    answer: "1",
    choices: [
      "If the handler of a child is clicked, the handler of the parent will also work",
  ...
  function check(event) {
    ...
    if (initials) {
      ...
      // Else- alert the user to input 2 characters
        ...
        alert(
          "Please enter your initials (do not include punctuation, 2 characters long) For Example: 'PB'"
        );
      }
    }
